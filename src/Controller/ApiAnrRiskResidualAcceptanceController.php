...
class ApiAnrRiskResidualAcceptanceController extends AbstractRestfulControllerRequestHandler
{
    ...
    public function create($data)
    {
        ...
        return $this->getSuccessfulJsonResponse(
            $this->prepareRiskData($this->residualRiskAcceptanceService->decideInformationRisk($anr, $riskId, (array)$data))
        );
    }

    private function prepareRiskData(InstanceRisk $risk): array
    {
        return [
            'id' => $risk->getId(),
