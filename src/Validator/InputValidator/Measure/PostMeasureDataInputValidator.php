...
use Monarc\Core\Validator\InputValidator\Measure\PostMeasureDataInputValidator as CorePostMeasureDataInputValidator;

class PostMeasureDataInputValidator extends CorePostMeasureDataInputValidator
{
