...
class AnrRecordService extends AbstractService
{
    ...
    public function duplicateRecord($recordId, $newLabel)
    {
        ...
        $newRecord = new \Monarc\FrontOffice\Model\Entity\Record($entity);
    ...
    * @throws \Monarc\Core\Exception\Exception If the record is not found
    */
     ...
     * @throws \Monarc\Core\Exception\Exception If the posted data is invalid, or ANR ID is invalid
     */
