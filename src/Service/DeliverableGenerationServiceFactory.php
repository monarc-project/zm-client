...
class DeliverableGenerationServiceFactory extends AbstractServiceFactory
{
    protected $ressources = [
        ...
        'recommendationRiskTable' => Table\RecommendationRiskTable::class,
        'recommendationHistoryTable' => Table\RecommendationHistoryTable::class,
        'metadatasOnInstancesTable' => Table\AnrInstanceMetadataFieldTable::class,
