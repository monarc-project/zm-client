 ...
 */
class AnrAssetCommonService extends \Monarc\Core\Service\AbstractService
{
    protected $anrTable;
    protected $amvTable;
    protected $clientity;
     ...
     * @throws \Monarc\Core\Exception\Exception If the ANR does not exist
     */
    public function getListAssets($anrId)
    {
        ...
        if ($anr) {
            ...
            throw new \Monarc\Core\Exception\Exception('Anr does not exist', 412);
        }
    }
     ...
     * @throws \Monarc\Core\Exception\Exception If the ANR mismatches or the entity does not exist
     */
    public function getAsset($anrId, $assetId)
    {
        ...
        if ($anr) {
            ...
            if ($asset) {
                ...
                throw new \Monarc\Core\Exception\Exception('Asset does not exist', 412);
            }
        } else {
            throw new \Monarc\Core\Exception\Exception('Anr does not exist', 412);
        }
     ...
     * @throws \Monarc\Core\Exception\Exception If the asset or ANR does not exist
     */
