...
class AnrObjectService extends \Monarc\Core\Service\ObjectService
{
     ...
     * @throws \Monarc\Core\Exception\Exception If the ANR ID is not set or invalid
     */
     ...
     * @throws \Monarc\Core\Exception\Exception If the ANR is invalid, or the object ID is not found
     */
    public function getCommonEntity($anrId, $id)
    {
        ...
        if (!empty($object)) {
            ...
            throw new \Monarc\Core\Exception\Exception('Object not found', 412);
        }
    }
