...
/**
 * Api Anr RecommandationsSets Controller
 *
 * Class ApiAnrRecommandationsSetsController
 * @package MonarcFO\Controller
 */
class ApiAnrRecommandationsSetsController extends ApiAnrAbstractController
{
    protected $name = 'recommandations-sets';
    protected $dependencies = ['anr', 'recommandations'];
