...
class InitialDb extends AbstractMigration
{
    ...
    public function change()
    {
        ...
        // Migration for table anrs_objects
        ...
        $table
            ...
            ->addColumn('first_user_firstname', 'string', array('null' => true, 'limit' => 255))
            ->addColumn('first_user_lastname', 'string', array('null' => true, 'limit' => 255))
            ->addColumn('first_user_email', 'string', array('null' => true, 'limit' => 255))
            ->addColumn('first_user_phone', 'string', array('null' => true, 'limit' => 20))
            ->addColumn('creator', 'string', array('null' => true, 'limit' => 255))
            ->addColumn('created_at', 'datetime', array('null' => true))
            ->addColumn('updater', 'string', array('null' => true, 'limit' => 255))
            ->addColumn('updated_at', 'datetime', array('null' => true))
        ...
        //Migration for instances consequences
        ...
        $table
            ...
            ->addColumn('language', 'integer', array('null' => true, 'limit' => 255))
            ->addColumn('creator', 'string', array('null' => true, 'limit' => 255))
            ->addColumn('created_at', 'datetime', array('null' => true))
            ->addColumn('updater', 'string', array('null' => true, 'limit' => 255))
            ->addColumn('updated_at', 'datetime', array('null' => true))
        ...
        // Migration for table users_anrs
        ...
        $table
            ->addForeignKey('anr_id', 'anrs', 'id', array('delete' => 'CASCADE','update' => 'RESTRICT'))
            ->addForeignKey('theme_id', 'themes', 'id', array('delete' => 'CASCADE','update' => 'RESTRICT'))
            ->update();
        $table = $this->table('users_anrs');
        $table
            ->addForeignKey('user_id', 'users', 'id', array('delete' => 'RESTRICT','update' => 'RESTRICT'))
