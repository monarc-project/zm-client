...
class FixTextFieldsConsistency extends AbstractMigration
{
    ...
    {
        $this->execute(
            'ALTER TABLE `records` CHANGE `purposes` `purposes` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
               CHANGE `sec_measures` `sec_measures` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
             ALTER TABLE `record_recipients` CHANGE `description` `description` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
             ALTER TABLE `record_processors` CHANGE `activities` `activities` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
                CHANGE `sec_measures` `sec_measures` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
            ALTER TABLE `record_personal_data` CHANGE `data_subject` `data_subject` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
                CHANGE `description` `description` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
            ALTER TABLE `record_international_transfers` CHANGE `description` `description` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
            ALTER TABLE `snapshots` CHANGE `comment` `comment` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
            ALTER TABLE `soa` CHANGE `justification` `justification` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
                CHANGE `evidences` `evidences` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
                CHANGE `actions` `actions` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
                CHANGE `compliance` `compliance` SMALLINT UNSIGNED NULL DEFAULT NULL;
